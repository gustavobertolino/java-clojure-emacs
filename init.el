...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(rainbow-delimiters flycheck-clj-kondo helm-clojuredocs flycheck-clojure clojure-quick-repls clojure-snippets clojure-mode golden-ratio neotree lsp-java helm-lsp lsp-ui dap-mode flycheck yasnippet-snippets company quickrun which-key avy helm-swoop helm-descbinds helm projectile use-package-chords heaven-and-hell doom-themes exec-path-from-shell use-package)))
